...
<ul>
  ...
  <li><a href="twilioApi.php" class="active">Twilio</a></li>
  <li style="float:right"><a href="../login.php">Logout</a></li>
        ...
        <div class="zones">
        <h1 class="company">Twilio                       
            <img src="../images/twilioLogo.png" alt="" width="30"/></h1>
...
<!--        <form action="../logout.php">
    ...
    $('.button').click(function(){
        ...
        var ajaxurl = '../apiFunctions/twilioFunctions.php',
...
//code zone 2
    ...
    $('.button2').click(function(){
        var clickBtnValue = $(this).val();
        var ajaxurl = '../apiFunctions/twilioZone2.php',
        data =  {'action': clickBtnValue};
        $.post(ajaxurl, data, function (response) {
            // Response div goes here.
